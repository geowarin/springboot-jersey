 ...
 *         <p/>
 *         This version has been modified to allow direct configuration of the spring context via the
 *         'contextConfig' parameter.
 *         If this doesn't somehow get merged into jersey, it is a big hack relying on classLoader precedence
 *         to override the eponym implementation of jersey-spring3 that gets loaded thanks to Java SPI
 */
public class SpringComponentProvider implements ComponentProvider {

    private static final Logger LOGGER = Logger.getLogger(org.glassfish.jersey.server.spring.SpringComponentProvider.class.getName());
    ...
    public static final String PARAM_SPRING_CONTEXT = "contextConfig";
    ...
    public boolean bind(Class<?> component, Set<Class<?>> providerContracts) {
        ...
        if (component.isAnnotationPresent(Component.class)) {
            ...
            ServiceBindingBuilder bb = Injections.newFactoryBinder(new org.glassfish.jersey.server.spring.SpringComponentProvider.SpringManagedBeanFactory(ctx, locator, beanName));
            bb.to(component);
